...
public class DinnerBarGraph extends AppCompatActivity implements OnChartValueSelectedListener {

    private String tag = DinnerBarGraph.class.getSimpleName();
    ...
    private DinnerHistoryAdapter mDinnerHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        mDinnerHistoryAdapter = new DinnerHistoryAdapter(this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mDinnerHistoryAdapter);
...
//                if ((j == getDay(mlist.get(k).getDate()))) {
//
//                    Log.d(tag, "Value of K : " + k);
//                    Log.d(tag, "SIZE OF mlist(k) : " + mlist.size());
//                    Log.d(tag, "DATE : " + mlist.get(k).getDate());
//                    Log.d(tag, "Calories of food : " + mlist.get(k).getCalories());
//                    Log.d(tag, "Timestamp : " + mlist.get(k).getTimestamp());
//                    Log.d(tag, "Type of Food : " + mlist.get(k).getTypeOfFood());
//
//                    dinnerArrayList.add(new BarEntry(j, (mlist.get(k).getCalories())));
//
//                    totalLeftXis = (int) (totalLeftXis + (mlist.get(k).getCalories()));
                    grapAdded = true;
                    break;
                } else {
                    grapAdded = false;
...
//        setSteps.setAxisDependency(YAxis.AxisDependency.LEFT);
        setDinner.setColor(getResources().getColor(R.color.colorCalories));

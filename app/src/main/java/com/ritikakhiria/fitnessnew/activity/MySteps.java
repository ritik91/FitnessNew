...
public class MySteps extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public ImageView ImgRunning, ImgWalking, ImgStairs, ImgDistance, ImgCalories;
    ...
    private void init() {
        ...
        mfitChart = (FitChart) findViewById(R.id.fitChart);
        mfitChart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stepsIntent = new Intent(MySteps.this, StepsBarGraph.class);
                startActivity(stepsIntent);
            }
        });

        ImgRunning = (ImageView)findViewById(R.id.imageRunning);
        ImgRunning.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent runningIntent = new Intent(MySteps.this, RunningBarGraph.class);
                startActivity(runningIntent);
            }
        });

        ImgWalking = (ImageView)findViewById(R.id.imageWalking);
        ImgWalking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent walkingIntent = new Intent(MySteps.this, WalkingBarGraph.class);
                startActivity(walkingIntent);
            }
        });

        ImgStairs = (ImageView)findViewById(R.id.imageStairs);
        ImgStairs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stairsIntent = new Intent(MySteps.this, StairsBarGraph.class);
                startActivity(stairsIntent);
            }
        });

        ImgCalories = (ImageView)findViewById(R.id.imageCaloriesBurned);
        ImgCalories.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent caloriesIntent = new Intent(MySteps.this, CaloriesBarGraph.class);
                startActivity(caloriesIntent);
            }
        });

        ImgDistance = (ImageView)findViewById(R.id.imageDistance);
        ImgDistance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent distanceIntent = new Intent(MySteps.this, DistanceBarGraph.class);
...
//
    ...
    public void updateViews(Intent intent) {
        ...
        lblWalkingCount.setText(walk + " min");
        lblCaloriesBurned.setText(calories + " kcal");
        lblRunningCount.setText(running + " min");
        lblStairCount.setText(stair + " min");

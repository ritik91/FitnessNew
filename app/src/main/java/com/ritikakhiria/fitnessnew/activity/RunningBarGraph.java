...
public class RunningBarGraph extends AppCompatActivity implements OnChartValueSelectedListener {
    private String tag = RunningBarGraph.class.getSimpleName();
    ...
    private RunningHistoryAdapter mRunningHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        mRunningHistoryAdapter = new RunningHistoryAdapter(this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mRunningHistoryAdapter);
    ...
    private void setData() {
        ...
        ArrayList<BarEntry> runningArrayList = new ArrayList<BarEntry>();
...
//                Log.d(tag, "totalSteps : " + mlist.get(i).getSteps());
                Log.d(tag, "running : " + mlist.get(i).getRunning());
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < mlist.size(); k++) {
                if (j == getDay(mlist.get(k).getSaveDate())) {
                    ...
                    runningArrayList.add(new BarEntry(j, mlist.get(k).getRunning()));
            ...
            if (!grapAdded) {
                ...
                runningArrayList.add(new BarEntry(j, 0, getDayName(j)));
            }
        ...
        BarDataSet setRunning;

        // create a dataset and give it a type

        setRunning = new BarDataSet(runningArrayList, "");
...
//        setSteps.setHighLightColor(Color.rgb(244, 117, 117));
        ...
        BarData data = new BarData(setRunning);
    ...
    public class RunningHistoryAdapter extends RecyclerView.Adapter<RunningBarGraph.RunningHistoryAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            private TextView tvTimestamp, tvRunning;

            public MyViewHolder(View view) {
                super(view);
                tvTimestamp = (TextView) view.findViewById(R.id.tvTimestamp);
                tvRunning = (TextView) view.findViewById(R.id.tvSteps);
            }
        }

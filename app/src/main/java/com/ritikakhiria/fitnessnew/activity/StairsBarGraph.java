...
public class StairsBarGraph extends AppCompatActivity implements OnChartValueSelectedListener {

    private String tag = StairsBarGraph.class.getSimpleName();
    ...
    private StairsHistoryAdapter mStairsHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        mStairsHistoryAdapter = new StairsHistoryAdapter(this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mStairsHistoryAdapter);
    ...
    private void setData() {
        ...
        ArrayList<BarEntry> stairsArrayList = new ArrayList<BarEntry>();
...
//                Log.d(tag, "totalSteps : " + mlist.get(i).getSteps());
                Log.d(tag, "stairs : " + mlist.get(i).getStairs());
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < mlist.size(); k++) {
                if (j == getDay(mlist.get(k).getSaveDate())) {
                    ...
                    Log.d(tag, "Value of walking : " + mlist.get(k).getStairs());

                    stairsArrayList.add(new BarEntry(j, mlist.get(k).getStairs()));

                    totalLeftXis = totalLeftXis + mlist.get(k).getStairs();
                    grapAdded = true;
                    break;
                } else {
                    grapAdded = false;
            ...
            if (!grapAdded) {
                ...
                stairsArrayList.add(new BarEntry(j, 0, getDayName(j)));
            }
        ...
        leftAxis.setAxisMaximum(totalLeftXis + 15);

        BarDataSet setStairs;

        // create a dataset and give it a type

        setStairs = new BarDataSet(stairsArrayList, "");
...
//        setSteps.setHighLightColor(Color.rgb(244, 117, 117));
        ...
        BarData data = new BarData(setStairs);
    ...
    public class StairsHistoryAdapter extends RecyclerView.Adapter<StairsBarGraph.StairsHistoryAdapter.MyViewHolder> {

        private Context context;

        public StairsHistoryAdapter(Context context) {
            super();
            this.context = context;
        }

        public class MyViewHolder extends RecyclerView.ViewHolder {
            private TextView tvTimestamp, tvStairs;

            public MyViewHolder(View view) {
                super(view);
                tvTimestamp = (TextView) view.findViewById(R.id.tvTimestamp);
                tvStairs = (TextView) view.findViewById(R.id.tvSteps);
            }
        }
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            Log.d(tag, "Walking Steps : " + HistoryModel.getRunning());

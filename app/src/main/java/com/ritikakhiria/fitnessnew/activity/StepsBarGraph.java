...
public class StepsBarGraph extends AppCompatActivity implements OnChartValueSelectedListener{
    private String tag = StepsBarGraph.class.getSimpleName();
    ...
    private StepsHistoryAdapter mStepsHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        historyModels = DBHelper.getInstance(StepsBarGraph.this).getAllTracking();
        ...
        mStepsHistoryAdapter = new StepsHistoryAdapter(StepsBarGraph.this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(StepsBarGraph.this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mStepsHistoryAdapter);
    ...
    private void setData() {
        ...
        ArrayList<BarEntry> stepsArrayList = new ArrayList<BarEntry>();
...
//                Log.d(tag, "totalSteps : " + mlist.get(i).getSteps());
        ...
        for (int j = 0; j < 7; j++) {
            ...
            if (!grapAdded) {
                ...
                stepsArrayList.add(new BarEntry(j, 0, getDayName(j)));
            }
        ...
        setSteps = new BarDataSet(stepsArrayList, "");
...
//        setSteps.setHighLightColor(Color.rgb(244, 117, 117));
        ...
        BarData data = new BarData(setSteps);
    ...
    public class StepsHistoryAdapter extends RecyclerView.Adapter<StepsBarGraph.StepsHistoryAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.tvSteps.setText(HistoryModel.getSteps() + " Steps");
        }

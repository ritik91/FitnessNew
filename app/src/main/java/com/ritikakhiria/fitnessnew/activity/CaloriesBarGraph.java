...
public class CaloriesBarGraph extends AppCompatActivity implements OnChartValueSelectedListener {

    private String tag = CaloriesBarGraph.class.getSimpleName();
    ...
    private CaloriesHistoryAdapter mCaloriesHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        mCaloriesHistoryAdapter = new CaloriesHistoryAdapter(this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mCaloriesHistoryAdapter);
    ...
    private void setData() {
        ...
        ArrayList<BarEntry> caloriesArrayList = new ArrayList<BarEntry>();
...
//                Log.d(tag, "totalSteps : " + mlist.get(i).getSteps());
                Log.d(tag, "Calories Burned : " + mlist.get(i).getCaloriesBurned());
                Log.d(tag, "Date : " + mlist.get(i).getSaveDate());
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < mlist.size(); k++) {
                if (j == getDay(mlist.get(k).getSaveDate())) {
                    ...
                    Log.d(tag, "Value of calories burned : " + mlist.get(k).getCaloriesBurned());

                    caloriesArrayList.add(new BarEntry(j, mlist.get(k).getCaloriesBurned()));

                    totalLeftXis = (int) (totalLeftXis + (mlist.get(k).getCaloriesBurned()));
                    grapAdded = true;
                    break;
                } else {
                    grapAdded = false;
            ...
            if (!grapAdded) {
                ...
                caloriesArrayList.add(new BarEntry(j, 0, getDayName(j)));
            }
        ...
        BarDataSet setCalories;

        // create a dataset and give it a type

        setCalories = new BarDataSet(caloriesArrayList, "");
...
//        setSteps.setHighLightColor(Color.rgb(244, 117, 117));
        ...
        BarData data = new BarData(setCalories);
    ...
    public class CaloriesHistoryAdapter extends RecyclerView.Adapter<CaloriesBarGraph.CaloriesHistoryAdapter.MyViewHolder> {

        private Context context;

        public CaloriesHistoryAdapter(Context context) {
            super();
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.tvCalories.setText(Utils.roundDouble(HistoryModel.getCaloriesBurned(),1) + " Kcal");
        }

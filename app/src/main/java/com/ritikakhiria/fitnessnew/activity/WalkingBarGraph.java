...
public class WalkingBarGraph extends AppCompatActivity implements OnChartValueSelectedListener {

    private String tag = WalkingBarGraph.class.getSimpleName();
    ...
    private WalkingHistoryAdapter mWalkingHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        mWalkingHistoryAdapter = new WalkingHistoryAdapter(this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mWalkingHistoryAdapter);
    ...
    private void setData() {
        ...
        ArrayList<BarEntry> walkingArrayList = new ArrayList<BarEntry>();
...
//                Log.d(tag, "totalSteps : " + mlist.get(i).getSteps());
                Log.d(tag, "walking : " + mlist.get(i).getWalking());
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < mlist.size(); k++) {
                if (j == getDay(mlist.get(k).getSaveDate())) {
                    ...
                    walkingArrayList.add(new BarEntry(j, mlist.get(k).getWalking()));

                    totalLeftXis = totalLeftXis + mlist.get(k).getRunning();
                    grapAdded = true;
                    break;
                } else {
                    grapAdded = false;
            ...
            if (!grapAdded) {
                ...
                walkingArrayList.add(new BarEntry(j, 0, getDayName(j)));
            }
        ...
        BarDataSet setWalking;

        // create a dataset and give it a type

        setWalking = new BarDataSet(walkingArrayList, "");
...
//        setSteps.setHighLightColor(Color.rgb(244, 117, 117));
        ...
        BarData data = new BarData(setWalking);
    ...
    public class WalkingHistoryAdapter extends RecyclerView.Adapter<WalkingBarGraph.WalkingHistoryAdapter.MyViewHolder> {

        private Context context;

        public WalkingHistoryAdapter(Context context) {
            super();
            this.context = context;
        }

        public class MyViewHolder extends RecyclerView.ViewHolder {
            private TextView tvTimestamp, tvWalking;

            public MyViewHolder(View view) {
                super(view);
                tvTimestamp = (TextView) view.findViewById(R.id.tvTimestamp);
                tvWalking = (TextView) view.findViewById(R.id.tvSteps);
            }
        }

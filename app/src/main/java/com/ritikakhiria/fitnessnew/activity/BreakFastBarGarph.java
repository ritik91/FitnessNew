...
public class BreakFastBarGarph extends AppCompatActivity implements OnChartValueSelectedListener {

    private String tag = BreakFastBarGarph.class.getSimpleName();
    ...
    private BreakfastHistoryAdapter mBreakfastHistoryAdapter = null;
...
//        mChart.setHighlightPerDragEnabled(true);
        ...
        mBreakfastHistoryAdapter = new BreakfastHistoryAdapter(this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mBreakfastHistoryAdapter);
    ...
    private void setData() {
        ...
        ArrayList<BarEntry> breakfastArrayList = new ArrayList<BarEntry>();

        ArrayList<HashMap<String, String>> mlist = new ArrayList<>(DBHelper.getInstance(this).nutritionWeeklyDataBreakfast());
//        ArrayList<Foods> mlist1 = new ArrayList<Foods>();
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < mlist.size(); k++) {
                if ((j == getDay(mlist.get(k).get("date")))) {
                    ...
                    breakfastArrayList.add(new BarEntry(j, Float.parseFloat(mlist.get(k).get("totalCalories"))));
            ...
            if (!grapAdded) {
                ...
                breakfastArrayList.add(new BarEntry(j, 0, getDayName(j)));
            }
        ...
        BarDataSet setBreakfast;

        // create a dataset and give it a type

        setBreakfast = new BarDataSet(breakfastArrayList, "");
//        setSteps.setAxisDependency(YAxis.AxisDependency.LEFT);
        setBreakfast.setColor(getResources().getColor(R.color.colorCalories));
//        setSteps.setHighLightColor(Color.rgb(244, 117, 117));

        // create a data object with the datasets
        BarData data = new BarData(setBreakfast);
    ...
    public class BreakfastHistoryAdapter extends RecyclerView.Adapter<BreakFastBarGarph.BreakfastHistoryAdapter.MyViewHolder> {

        private Context context;

        public BreakfastHistoryAdapter(Context context) {
            super();
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            if (nutritionModel.getTypeOfFood().equals(1) && (nutritionModel.getTypeOfFood() != 2) && (nutritionModel.getTypeOfFood() != 3)) {

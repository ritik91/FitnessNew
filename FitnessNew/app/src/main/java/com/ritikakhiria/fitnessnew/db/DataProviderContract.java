...
public class DataProviderContract {
    ...
    public static final class Tracking implements BaseColumns {
        ...
        public static final String CREATE_TABLE =
                "CREATE TABLE Tracking ("+_ID+" INTEGER PRIMARY KEY, "+TIMESTAMP+" INTEGER, "+CALORIES+" VARCHAR(20), "+DISTANCE+" VARCHAR(20), "+WALKING+" INTEGER, "+RUNNING+" INTEGER, "+STAIRS+" INTEGER, "+DATA+" TEXT, "+SAVE_DATE+" VARCHAR(20), "+STEPS+" INTEGER, "+MONTH+" INTEGER, "+STATUS+" INTEGER DEFAULT 0);";
    }
    ...
    public static final class Nutrition implements BaseColumns {
        ...
        // create Users table
        public static final String CREATE_TABLE =
                "CREATE TABLE Nutrition (_id INTEGER PRIMARY KEY, timestamp INTEGER, calories VARCHAR(20), fat VARCHAR(20), fiber VARCHAR(20), sugar VARCHAR(20), carbs VARCHAR(20), protein VARCHAR(20), date VARCHAR(20), month INTEGER, typeOfFood INTEGER, status INTEGER DEFAULT 0);";
    }
}
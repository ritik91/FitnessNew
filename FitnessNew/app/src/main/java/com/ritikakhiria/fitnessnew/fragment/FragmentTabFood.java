...
import com.ritikakhiria.fitnessnew.adapter.FoodAdapter;
...
public class FragmentTabFood extends Fragment implements View.OnClickListener {

    public static final String TAG = FragmentTabFood.class.getSimpleName();
...
//                foodSearch.collapseActionView();
    ...
    private void initAdapter() {
        genericFoodList = new ArrayList<>();
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        mRecyclerView.setNestedScrollingEnabled(false);
        mRecyclerView.setLayoutManager(linearLayoutManager);
        foodAdapter = new FoodAdapter(getActivity(), genericFoodList, this);
    ...
    private void searchRecipe(String recipeName) {
        ...
        webCalls.getGroceryFoodList(searchModel);
            ...
            public void OnWebCallSuccess(String userFullData) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        GenericFood genericFoodModel = new GenericFood();
                        JSONObject jsonObjectItems = jsonArray.getJSONObject(i);
                        genericFoodModel.setGenericFoodName(jsonObjectItems.getString("food_name"));
                        genericFoodModel.setServingQuanity(jsonObjectItems.getString("serving_qty"));
                        ...
                        genericFoodModel.setGenericFoodNixItemId(jsonObjectItems.getString("nix_item_id"));
                        ...
                        genericFoodModel.setGenericFoodImage(jsonObjectPhoto.getString("thumb"));
                        genericFoodList.add(genericFoodModel);
                    }
                } catch (Exception e) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.ll_particular_product_row:
                ...
                mbundle.putString("nixItemId",genericFoodList.get(clickedPos).getGenericFoodNixItemId());

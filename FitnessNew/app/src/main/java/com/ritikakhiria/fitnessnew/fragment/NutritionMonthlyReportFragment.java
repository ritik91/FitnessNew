...
public class NutritionMonthlyReportFragment extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_nutrition_monthly_report, container, false);
...
//        avgSugar = (TextView) view.findViewById(R.id.avg_sugar_value);
    ...
    private void setData(int count, float range) {
        ...
        ArrayList<HashMap<String, String>> mlist = new ArrayList<>(DBHelper.getInstance(getActivity()).monthlyNutritionData());
        for (int j=0; j < 3; j++) {

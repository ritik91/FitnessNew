...
////import com.ritikakhiria.fitnessnew.Volley.AppController;
////import com.ritikakhiria.fitnessnew.activity.RecipeSearchActivity;
//import com.ritikakhiria.fitnessnew.activity.RecipeSearchActivity;
...
//
//
//public class FragmentTabRecipe extends Fragment implements View.OnClickListener {
//    public static final String TAG = FragmentTabRecipe.class.getSimpleName();
//
//    View view;
...
//    private ImageButton recipeVoiceButton;
...
//        view = inflater.inflate(R.layout.fragment_tab_recipe, container, false);
//
//        mRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);
//
//        recipeSearch = (SearchView) view.findViewById(R.id.edt_search);
//        recipeVoiceButton = (ImageButton) view.findViewById(R.id.voice_recipe);
//        recipeVoiceButton.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//
//        recipeSearch.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener()
//        {
//            @Override
...
//                recipeSearch.setIconified(true);
...
//                        JSONObject currentRecipe = jsonObjectItems.getJSONObject("recipe");
//                        recipeModel.setName(currentRecipe.getString("label"));
////                        recipeModel.setServingQuanity(currentRecipe.getString("yield"));
//                        int serving = currentRecipe.getInt("yield");
//                        recipeModel.setServingQuanity(String.valueOf(serving));
//                        int caloriesCal = currentRecipe.getInt("calories");
//                        int caloriePerPerson = (caloriesCal/serving);
//                        recipeModel.setCalories(String.valueOf(caloriePerPerson));
//                        recipeModel.setSource(currentRecipe.getString("source"));
//                        recipeModel.setRecipeFoodImage(currentRecipe.getString("image"));
//                        Log.d(TAG,"Food Name : "+jsonArray.length());
//                        JSONObject jsonObjectNutrient = currentRecipe.getJSONObject("totalNutrients");
//
////                        JSONObject fat = jsonObjectNutrient.getJSONObject("FAT");
////                        recipeModel.setFat(fat.getString("quantity"));
////
////                        JSONObject carbs = jsonObjectNutrient.getJSONObject("CHOCDF");
////                        recipeModel.setCarbs(carbs.getString("quantity"));
////
////                        JSONObject protein = jsonObjectNutrient.getJSONObject("PROCNT");
////                        recipeModel.setProtein(protein.getString("quantity"));
//
...
//                mbundle.putString("label",recipeList.get(clickedPos).getName());
